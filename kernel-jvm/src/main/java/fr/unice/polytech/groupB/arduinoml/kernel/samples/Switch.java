...
//        off.setActions(Arrays.asList(switchTheLightOff));
//
//        ConditionAction button1High = new ConditionAction();
//        button1High.setSensor(button1);
//        button1High.setValue(SIGNAL.HIGH);
//        button1High.setCombination(Condition.AND);
//
//        ConditionAction button2High = new ConditionAction();
//        button2High.setSensor(button2);
//        button2High.setValue(SIGNAL.HIGH);
//
//        List<ConditionAction> conditionsOff2On = new ArrayList<>();
//        conditionsOff2On.add(button1High);
//        conditionsOff2On.add(button2High);
//
//        ConditionAction button1Low = new ConditionAction();
//        button1Low.setSensor(button1);
//        button1Low.setValue(SIGNAL.LOW);
//        button1Low.setCombination(Condition.OR);
//
//        ConditionAction button2Low = new ConditionAction();
//        button2Low.setSensor(button2);
//        button2Low.setValue(SIGNAL.LOW);
//
//        List<ConditionAction> conditionsOn2Off = new ArrayList<>();
